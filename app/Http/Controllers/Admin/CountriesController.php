...
class CountriesController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = Country::with(['group'])->select(sprintf('%s.*', (new Country())->table));
            ...
            $table->addColumn('group_group_name', function ($row) {
                return $row->group ? $row->group->group_name : '';
            });
    ...
    public function create()
    {
        ...
        return view('admin.countries.create', compact('groups'));
    }
    ...
    public function edit(Country $country)
    {
        ...
        return view('admin.countries.edit', compact('country', 'groups'));
    }
    ...
    public function show(Country $country)
    {
        ...
        $country->load('group', 'countryBanks');
