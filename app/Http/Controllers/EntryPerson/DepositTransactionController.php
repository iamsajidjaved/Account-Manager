...
class DepositTransactionController extends Controller
{
    public function create(Request $request, $bank_id)
    {
        ...
        if(in_array('Entry Person', $roles)){
            ...
            $transactions = Transaction::whereIn('bank_id', $banks)->where('transaction_type', 'Deposit')->latest()->take(5)->get();
            return view('entry_person.transactions.deposit', compact('transactions','bank_id'));
        }
    }
